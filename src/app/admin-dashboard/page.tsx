        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-4">
            <div className="text-right">
              <div className="text-sm font-medium text-green-100">{adminProfile.name}</div>
              <div className="text-xs text-green-400/80">{adminProfile.email}</div>
            </div>
            <Button
              variant="ghost"
              size="sm"
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-white/5 backdrop-blur-xl border-white/10 shadow-xl hover:bg-white/10 transition-all duration-300">
              <CardContent className="p-6">
                ...
                <div className="mt-6">
                  <div className="text-lg font-semibold text-green-100">Today:</div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center border border-white/10 ${stat.title.includes('Students') ? 'bg-green-500/20 text-green-400' :
                        stat.title.includes('Teachers') ? 'bg-emerald-500/20 text-emerald-400' :
                          stat.title.includes('Classes') ? 'bg-yellow-500/20 text-yellow-400' :
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4 max-h-96 overflow-y-auto pr-2 custom-scrollbar">
                  {notifications.map((notif, idx) => (
                    <div
                      key={notif.id || idx}
                      className="flex items-start space-x-3 p-3 rounded-lg hover:bg-white/5 transition-colors border border-transparent hover:border-white/5"
                    >
                ...
                {showAddNotification && (
                  ...
                  >
                    <div className="relative w-full max-w-md mx-auto ">
                      <div className="bg-[#0a2e18] border border-green-800/50 rounded-2xl shadow-2xl p-6 pt-10 py-40 relative animate-fadeIn">
                        <button
          ...
          <div className="space-y-6">
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <div className="text-sm text-green-400/80">{currentMonth}</div>
                  </div>
                  <div className="flex space-x-1">
                    <Button variant="ghost" size="sm" className="p-1 h-8 w-8 text-green-400 hover:bg-white/10 hover:text-white">
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-7 gap-1 mb-2">
                    {daysOfWeek.map((day) => (
                      <div key={day} className="text-xs font-medium text-white text-center p-1">
                        {day}
                      </div>
                    ))}
                  </div>
                        ...
                        <div key={dayIndex} className="aspect-square flex items-center justify-center">
                          {day ? (
                            <Button
                              variant="ghost"
                              size="sm"
                              className={`w-8 h-8 p-0 text-sm ${day === today
                                ? "bg-green-500 text-white hover:bg-green-400 rounded-full shadow-[0_0_10px_rgba(34,197,94,0.4)]"
            ...
            <Card className="bg-white/5 backdrop-blur-xl border-white/10 shadow-xl">
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  <Button variant="outline" className="w-full justify-start border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white hover:border-white/20 transition-all" onClick={() => router.push('/admin/students')}>
                    <Users2 className="w-4 h-4 mr-2 text-green-400" />
                    Manage Students
                  </Button>
                  <Button variant="outline" className="w-full justify-start border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white hover:border-white/20 transition-all" onClick={() => router.push('/admin/teachers')}>
                    <Users2 className="w-4 h-4 mr-2 text-green-400" />
                    Manage Teachers
                  </Button>
                  <Button variant="outline" className="w-full justify-start border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white hover:border-white/20 transition-all" onClick={() => router.push('/admin/classes')}>
                    <TrendingUp className="w-4 h-4 mr-2 text-green-400" />
                    Manage Classes
                  </Button>
                  <Button variant="outline" className="w-full justify-start border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white hover:border-white/20 transition-all" onClick={() => router.push('/admin/subjects')}>
